...
\contest
{Летний олимпиадный лагерь 2019. День 6.}%
...
\input tasks/shopping
\input tasks/heating
\input tasks/square_cake
\input tasks/troyka
\input tasks/elections_in_USA
\input tasks/fraction_conversion
\input tasks/alien_genome
\input tasks/campus
\input tasks/calculator
