...
files\orders_validate.exe --group "1" < files\tests\validator-tests\01 2>> validator-tests.log
if errorlevel 1 (
...
echo Validator comment: 1>> validator-tests.log
files\orders_validate.exe --group "1" < files\tests\validator-tests\02 2>> validator-tests.log
if not errorlevel 1 (
...
echo Validator comment: 1>> validator-tests.log
files\orders_validate.exe --group "1" < files\tests\validator-tests\03 2>> validator-tests.log
if errorlevel 1 (
    echo Validator returned non-zero exit code for a valid test 1>> validator-tests.log
    echo Validator returned non-zero exit code for a valid test. See validator-tests.log for validator comment
    pause 0
