...
wine files/orders_validate.exe --group "1" < files/tests/validator-tests/01 2>> validator-tests.log
if [ "$?" -ne "0" ]; then
...
echo "Validator comment:" 1>> validator-tests.log
wine files/orders_validate.exe --group "1" < files/tests/validator-tests/02 2>> validator-tests.log
if [ "$?" -eq "0" ]; then
...
echo "Validator comment:" 1>> validator-tests.log
wine files/orders_validate.exe --group "1" < files/tests/validator-tests/03 2>> validator-tests.log
if [ "$?" -ne "0" ]; then
    echo "Validator returned non-zero exit code for a valid test" 1>> validator-tests.log
    echo "Validator returned non-zero exit code for a valid test. See validator-tests.log for validator comment"
    read
